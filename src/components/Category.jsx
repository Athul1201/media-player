...
function Category({dropVideoResponse}) {
  ...
  <button onClick={handleShow} className='btn btn-info'>Add-Category</button>
      ...
      >
        ...
        <Modal.Body>
          <input type='text' className='form-control' placeholder='category name' onChange={e=>setCategoryName(e.target.value)}></input>
        </Modal.Body>
        <Modal.Footer>
      ...
      </Modal>
      {
        allCategories?.length>0?allCategories.map(Category=>(
          <div className="border rounded p-3 m-5" droppable="true" onDragOver={e=>dragOver(e)} onDrop={e=>videoDrop(e,Category?.id)}>
